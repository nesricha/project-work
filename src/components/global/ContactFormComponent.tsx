...
export default function ContactFormComponent() {
  ...
  return (
    <div
      id="contact"
      className="bg-gradient-to-b from-dark-1 to-light-1 py-16 sm:py-24 px-10 shadow-md"
    >
      <h2 className="text-center font-bold text-light-1 text-3xl md:text-4xl py-3 md:py-5">
        CONTACT US
      </h2>
      ...
      >
        <div className="w-11/12 mx-auto pb-3">
          <label className="block p-1" htmlFor="name">
            Name *:{" "}
          </label>
          <input
        ...
        <div className="w-11/12 mx-auto pb-3">
          <label className="block p-1" htmlFor="message">
            Message:{" "}
          </label>
          <textarea
            className="w-full p-2 rounded-md focus-visible:outline-light-2"
        ...
        {!filledRequired && (
          <p className="pt-4 w-11/12 mx-auto">
